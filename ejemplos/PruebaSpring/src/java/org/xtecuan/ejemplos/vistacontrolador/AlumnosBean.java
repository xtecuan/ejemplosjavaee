...
import org.xtecuan.ejemplos.modelo.app.cmd.App;
...
public class AlumnosBean implements Serializable {
    ...
    private JdbcService alumnosFacade;
    ...
    public void actualizarInformacion(ActionEvent event) {
        int salida = JdbcService.FALLO_AL_ACTUALIZAR;
        ...
        if (alumno != null) {
            ...
            try {
                ...
                if (salida == JdbcService.EXITO_AL_ACTUALIZAR) {
    ...
    public void guardarInformacion(ActionEvent event) {
        ...
        if (alumno != null) {
            ...
            try {
                ...
                adicionarError("Error al guardar el alumno en la base de datos!!!" + ex.getMessage());
            }
        }
    ...
    public void borrarInformacion(ActionEvent event) {
        ...
        try {
            ...
            if (r == JdbcService.EXITO_AL_BORRAR) {
