...
public class ReferenceDataRepository {
    ...
    public void guardar(State estado) {
        ...
        Object[] params = {estado.getId(), estado.getStateCode(), estado.getName()};

        int result = this.jdbcTemplate.update("insert into current_states(id, state_code, name) values(?,?,?)", params);
